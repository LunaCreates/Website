...
async function deliveryData() {
  const data = await Cache(`${process.env.STOREFRONT_API_URL}?delivery`, {
    duration: '1d',
    type: 'json',
    fetchOptions: {
      method: 'POST',
